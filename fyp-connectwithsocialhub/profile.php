...
<body>
    <div class="container">
        ...
        ?>
                ...
                <?php if ($flag == 0) { ?>
                    <div class="profile">
                        <div class="changeprofile">Edit Profile Picture</div>
                        <br>
                        <form action="" method="post" enctype="multipart/form-data">
                            <div>
                                <label class="upload" onchange="showPath()">
                                    <span class='isbutton' id="path" style="color: white;">... Browse</span>
                                    <input type="file" name="fileUpload" id="selectedFile">
                                </label>
                            </div>
                            <br>
                            <input class='isbutton' type="submit" value="Upload Image" name="profile">
                        </form>
                    </div>
                    <br>
                    <div class="profile">
                        ...
                        <form method="post" onsubmit="return validateNumber()">
                            <div>
                                <input class='inputnumber' type="number" name="number" id="phonenum">
                                <div class="required"></div>
                                <br>
                                <input class='isbutton' type="submit" value="Submit" name="phone">
                            </div>
                        </form>
                    </div>
                    <br>
