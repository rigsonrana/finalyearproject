        ...
        <div class="content">
            <div class="tabcontent" id="signin">
                <form method="post" onsubmit="return validateLogin()">
                    ...
                    <input class="inputfields" type="text" name="useremail" id="loginuseremail">
                    <div class="required"></div>
                    <br>
                    <label>Password<span>*</span></label><br>
                    <input class="inputfields" type="password" name="userpass" id="loginuserpass">
                    <div class="required"></div>
                    <br><br>
            ...
            <div class="tabcontent" id="signup">
                <form method="post" onsubmit="return validateRegister()">
                    ...
                    <input class="inputfields" type="text" name="userfirstname" id="userfirstname">
                    <div class="required"></div>
                    <br>
                    <!--Last Name-->
                    <label>Last Name<span>*</span></label><br>
                    <input class="inputfields" type="text" name="userlastname" id="userlastname">
                    <div class="required"></div>
                    <br>
                    <!--Nickname-->
                    <label>Nickname</label><br>
                    <input class="inputfields" type="text" name="usernickname" id="usernickname">
                    <div class="required"></div>
                    <br>
                    <!--Password-->
                    <label>Password<span>*</span></label><br>
                    <input class="inputfields" type="password" name="userpass" id="userpass">
                    <div class="required"></div>
                    <br>
                    <!--Confirm Password-->
                    <label>Confirm Password<span>*</span></label><br>
                    <input class="inputfields" type="password" name="userpassconfirm" id="userpassconfirm">
                    <div class="required"></div>
                    <br>
                    <!--Email-->
                    <label>Email<span>*</span></label><br>
                    <input class="inputfields" type="text" name="useremail" id="useremail">
                    <div class="required"></div>
                    <br>
                    <!--Birth Date-->
                    ...
                    <label>Female</label>
                    <input type="radio" name="usergender" value="O" id="othergender" class="usergender">
                    <label>othergender</label>
                    <div class="required"></div>
                    <br>
                    <!--Hometown-->
                    <label> Address </Address></label><br>
                    <input class="inputfields" type="text" name="userhometown" id="userhometown">
                    <br>
                    <!--Package Two-->
                    ...
                    <textarea class="captionbox" rows="12" name="userabout" id="userabout"></textarea>
                    <br><br>
