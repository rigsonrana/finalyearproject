<?php
// importing connection and upload features
require 'functions/functions.php';
//starts a session on server
session_start();
// Check whether user is logged on or not
if (!isset($_SESSION['user_id'])) {
    // if the user isn't logged in redirect to index.php
...
<body>
    <div class="container">
        ...
        <div class="createpost">
            <form method="post" action="" onsubmit="return validatePost()" enctype="multipart/form-data">
                ...
                <h4> Share it to the world! </h4>
                <span class="required" style="display:none;"> *You can't Leave the Caption Empty.</span><br>
                <textarea class='captionbox' rows="6" name="caption"></textarea>
        ...
        // check is query ran successfully
        if (!$query) {
    ...
    <script>
        ...
        function validatePost() {
            ...
            if (caption == "") {
                // if the caption is empty, error message is displayed
...
<?php
// handle post request sent from createpost.php
